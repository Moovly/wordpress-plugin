                    ...
                    <form @submit.prevent="submit" class="w-50">
                      <div class="form-group">
                        ...
                        <select name="quality" id="quality" v-model="settings.jobs.quality" class="form-control">
                          <option v-for="quality in settings.jobs.options" :key="quality.value" :value="quality.value">
                            {{ quality.text }}
                          </option>
                        </select>
                      </div>
                      <div class="form-group form-check">
                        <input
                            ...
                            false-value="0"
                        >
                        <label for="create_moov" class="form-check-label mt-1 ml-2">Save template submissions to
                          projects</label>
                      </div>
