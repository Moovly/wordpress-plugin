            ...
            <div class="row">
              <div class="col-12 col-md-6 col-lg-4">
                ...
                <p>
                  ...
                  <a href="https://developer.moovly.com/docs/personal-access-tokens" target="_blank">Personal Access
                    Token</a>
                  section of the documentation.
                </p>

                <p>You need to have a Moovly account in order to create access tokens. If you do not have an account
                  yet, head over to our <a href="https://www.moovly.com/sign-up" target="_blank">registration page</a>
                  and sign up.</p>
                <p>Personal access tokens are long lived, but do expire. When this happens, you will have to create a
                  new one. You can see how long your tokens are valid in the <a
                      href="https://developer.moovly.com/docs/personal-access-tokens">Personal Access Token</a> section
                </p>
              </div>
                  ...
                  <div class="input-group mb-5">
                    ...
                    <div class="input-group-append">
                      <a class="input-group-text" href="#" title="Show access token" @click.prevent="toggleToken">
                        <svg v-if="ui.token.show" class="input-icon" xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 20 20">
                          <path
                        ...
                        <svg v-else class="input-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                          <path
